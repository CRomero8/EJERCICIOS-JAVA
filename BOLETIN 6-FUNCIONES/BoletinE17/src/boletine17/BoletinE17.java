...
public class BoletinE17 {
    ...
    public static void main(String[] args) {
        // 17.Escriba una función que decida si dos números enteros positivos son amigos.
        //Dos números son si la suma de sus divisores (distintos de ellos mismos) son iguales.
