...
public class BoletinE36 {
    ...
    public static void main(String[] args) {
        //  DUF que toma una tabla bidimensional de enteros, representando un tablero de ajedrez.
        //Disponemos de las constantes PB (peón blanco), TN (torre negra), 
        //etc. (P, T, C, A, R, D). Dicho módulo debe devolver un valor booleano,
