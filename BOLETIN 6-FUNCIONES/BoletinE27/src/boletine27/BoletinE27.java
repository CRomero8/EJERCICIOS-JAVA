...
public class BoletinE27 {
    ...
    public static void main(String[] args) {
        // 27.Diseñar la función opera_tabla, a la que se le pasa dos tablas,
        //el número de elementos útiles y que operación se desea realizar: 
        //sumar, restar, multiplicar o dividir (mediante un carácter: 's',
